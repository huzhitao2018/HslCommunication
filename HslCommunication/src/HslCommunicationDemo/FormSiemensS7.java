...
public class FormSiemensS7 extends JDialog
{
    ...
    public void AddConnectSegment(JPanel panel){
        ...
        textField1.setText("192.168.10.180");
...
//        panelRead.add(button11);
    ...
    public void AddWrite(JPanel panel){
        ...
        label3.setBounds(9, 126,70, 17);
        panelWrite.add(label3);

        JTextArea textArea3 = new JTextArea();
        textArea3.setLineWrap(true);
        JScrollPane jsp = new JScrollPane(textArea3);
        jsp.setBounds(83,125,264, 100);
        panelWrite.add(jsp);
        ...
        button1.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                for (int i = 0 ;i <5 ;i++){
                    DemoUtils.ReadResultRender(siemensS7Net.ReadInt16(textField1.getText()),textField1.getText(), textArea3, jsp );
                    try {
                        Thread.sleep(200);
